...
Please see [the relevant section of the worker documentation][v1_58_notify_ases_from] for more information.

[v1_58_notify_ases_from]: workers.md#notifying-application-services
